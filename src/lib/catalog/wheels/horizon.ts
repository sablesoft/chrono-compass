...
export const horizon = {
    ...
    ready: true,
    info: [
        { defaultLabel: 'altitude', metaField: 'altitudeDeg', format: 'deg', enabled: false, spokes: '*' },
        ...
        { defaultLabel: 'max altitude', enabled: false, spokes: ['N'] },
        { defaultLabel: 'min altitude', enabled: false, spokes: ['S'] },
        { defaultLabel: 'zenith', spokes: ['N'] },
        { defaultLabel: 'nadir', spokes: ['S'] },
        { defaultLabel: 'above horizon', enabled: false, spokes: ['ENE', 'NE', 'NNE', 'N', 'NNW', 'NW', 'WNW'] },
        { defaultLabel: 'below horizon', enabled: false, spokes: ['WSW', 'SW', 'SSW', 'S', 'SSE', 'SE', 'ESE'] },
    ],
    ui: {
      'target': 'pointer',
    },
