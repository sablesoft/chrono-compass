...
export const plato = {
    ...
    info: [
        ...
        { defaultLabel: 'plato deviation', metaField: 'deviationDeg', format: 'deg', spokes: '*', enabled: true, modal: 'Angular distance in degrees between the active Earth-axis pole and the looker direction at this spoke timestamp.' },
