...
export const nodal = {
    ...
    info: [
        ...
        { defaultLabel: 'plane dist km', metaField: 'planeDistanceKm', enabled: false, format: 'km', spokes: '*', modal: 'Signed distance from the target to the reference plane in kilometers. Positive and negative values indicate opposite sides of the plane.' },
