...
The localized [Harmonic Calendar print supplement](harmonic-calendar-print-supplement.md) is appended automatically after the dated calendar. Its title and contents begin the guide, and each of the six main sections starts on a new printed page. Longer sections continue naturally onto following pages. No blank separator pages are inserted. Supplement pages follow the same duplex binding geometry: 24 mm at the top on front pages and at the bottom on reverse pages.
